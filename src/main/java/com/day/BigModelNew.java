...
public class BigModelNew extends WebSocketListener {
    ...
    public static final String appid = "aafe0117";
    public static final String apiSecret = "YWE2ZDNlNjRmNjgwZjZjMjFkNTExMThm";
    public static final String apiKey = "b74f689ba43617d8fe69b155975cf99c";
...
//      while (true){         //到时这里可以不用true，而是改成一个flag
        if(totalFlag){
